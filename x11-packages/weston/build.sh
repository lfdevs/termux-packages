...
TERMUX_PKG_DEPENDS="freerdp, libaml, libandroid-shmem, libcairo, libcairo, libdrm, libevdev, libglvnd, libseat, libwayland, libwebp, libxcb, libxcursor, libxkbcommon, littlecms, pango, pipewire, xcb-util-cursor"
